...
class ParamsModel(BaseModel):
    def __init__(self, **params_object):
        super(ParamsModel, self).__init__(**params_object)
        ...
        self.available = params_object.get('available')
        self.errors = params_object.get('errors')
        self.read_only = params_object.get('read_only')
        self.validated = params_object.get('validated')
